...
class CreateCivilCaseStatusLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('civil_case_status_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('civil_case_status_logs');
    }
}
