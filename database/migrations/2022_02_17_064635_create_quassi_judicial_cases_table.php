...
class CreateQuassiJudicialCasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quassi_judicial_cases', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('relevant_laws_id')->nullable();
            ...
            $table->mediumText('prayer_claims_by_psg')->nullable();
    ...
    {
        Schema::dropIfExists('quassi_judicial_cases');
    }
}
