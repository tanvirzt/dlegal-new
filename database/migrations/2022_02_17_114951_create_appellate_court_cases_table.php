...
class CreateAppellateCourtCasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('appellate_court_cases', function (Blueprint $table) {
            ...
            $table->string('trial_court_id')->nullable();
            ...
            $table->string('case_no_acd')->nullable();
            $table->string('date_of_filing_acd')->nullable();
            $table->integer('acd_court_id')->nullable();
            ...
            $table->string('appellant_designation_id')->nullable();
