...
class CreateSupremeCourtCaseStatusLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('supreme_court_case_status_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('supreme_court_case_status_logs');
    }
}
