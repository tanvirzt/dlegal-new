...
class CreateHighCourtCasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('high_court_cases', function (Blueprint $table) {
            ...
            $table->string('case_received_lawyer')->nullable();
            ...
            $table->string('appellant_designation')->nullable();
            $table->string('appellant_address')->nullable();
            $table->string('opposite_party_name')->nullable();
            $table->string('opposite_party_designation')->nullable();
            $table->string('opposite_party_address')->nullable();
            $table->string('party_steps_taken')->nullable();
            $table->string('case_status')->nullable();
            $table->string('fixed_hearing_court')->nullable();
            $table->string('court_steps_taken')->nullable();
