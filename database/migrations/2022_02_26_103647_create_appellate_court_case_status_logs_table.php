...
class CreateAppellateCourtCaseStatusLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('appellate_court_case_status_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('appellate_court_case_status_logs');
    }
}
