...
class CreateInternalCounselsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('internal_counsels', function (Blueprint $table) {
            $table->id();
            $table->string('chamber_name')->nullable();
            $table->string('internal_counsel_role_id')->nullable();
            $table->string('internal_counsel_name')->nullable();
    ...
    {
        Schema::dropIfExists('internal_counsels');
    }
}
