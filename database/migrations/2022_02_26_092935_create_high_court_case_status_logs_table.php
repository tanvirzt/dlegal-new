...
class CreateHighCourtCaseStatusLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('high_court_case_status_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('high_court_case_status_logs');
    }
}
