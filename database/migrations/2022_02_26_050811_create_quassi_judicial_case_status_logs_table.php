...
class CreateQuassiJudicialCaseStatusLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quassi_judicial_case_status_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('quassi_judicial_case_status_logs');
    }
}
