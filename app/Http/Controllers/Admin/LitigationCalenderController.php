...
// dd('case no, dof, court name ');
            ...
            $query2 = $query->where(['criminal_cases.case_infos_case_no' => $request->case_no, 'criminal_cases.received_date' => $received_date, 'criminal_cases.name_of_the_court_id' => $request->name_of_the_court_id]);
