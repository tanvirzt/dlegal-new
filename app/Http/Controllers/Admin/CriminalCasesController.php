...
//        echo "<pre>";print_r($data);die();
        ...
        $data = DB::table('criminal_cases')
            ...
            ->leftJoin('setup_companies', 'criminal_cases.company_organization_id', '=', 'setup_companies.id')
            ->leftJoin('setup_courts', 'criminal_cases.name_of_the_court_id', '=', 'setup_courts.id')
            ->leftJoin('setup_divisions', 'criminal_cases.division_id', '=', 'setup_divisions.id')
            ->leftJoin('setup_districts', 'criminal_cases.district_id', '=', 'setup_districts.id')
            ->leftJoin('setup_thanas', 'criminal_cases.thana_id', '=', 'setup_thanas.id')
            ->leftJoin('setup_laws', 'criminal_cases.relevant_law_id', '=', 'setup_laws.id')
            ->leftJoin('setup_sections', 'criminal_cases.relevant_sections_id', '=', 'setup_sections.id')
