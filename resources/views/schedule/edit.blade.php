                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto" style="padding:0 20px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control theme-input-style" placeholder="Place" name="place" value="{{old('place',$data->place)}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="details" rows="4" class="form-control theme-input- theme-input-style" placeholder="Enter details">{{old('details',$data->details)}}</textarea>
