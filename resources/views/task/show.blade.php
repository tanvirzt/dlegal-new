                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading" style="color: #0CA2A3; font-weight: bold; font-size: 18px;text-decoration: underline;" >Task Details</h3>
                            </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mx-auto" style="padding: 0 20px;">
                                            <div class="form-group">
                                                ...
                                                <select name="task_category_id" class="select2 form-control theme-input-style" disabled>
                                                    <option value="">Select Task Category</option>
                                                    @foreach ($categories as $category)
                                                    <option value="{{$category->id}}" {{$data->task_category_id == $category->id ? 'selected' : false}}>{{$category->category_name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="priority" class="select2 form-control theme-input-style" disabled>
