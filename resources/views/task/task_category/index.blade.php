                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"> Task Category </li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> Task Category List </h3>
                                <div class="float-right">
                                        <a href="{{ route('task.category.create') }}"><button
                                                class="btn btn-sm
                                    ...
                                    <tbody>
                                        @foreach ($data as $datum)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('task.category.edit', $datum->id) }}"><button
                                                            class="btn btn-info btn-sm" data-toggle="tooltip"
                                                            data-placement="top" title="Edit"><i
                                                                class="fas fa-edit"></i></button></a>

                                                    <form method="POST" action="{{ route('task.category.destroy', $datum->id) }}"
