        ...
        font-size: 12px;
                     ...
                     <!--       <div class="card-body">
                                ...
                                <table id="" class="table all-cases-dt dataTable no-footer dtr-inline">
                                    <thead>
                                        <tr>                                            
                                            <th class="text-left text-nowrap">To Do</th>
                                            <th class="text-left text-nowrap">In Progress</th>
                                            <th class="text-left text-nowrap">Due</th>
                                            <th class="text-left text-nowrap"> Completed </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($data as $datum)
