                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value="{{ $data->case_received_lawyer }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value="{{ $data->appellant_designation }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="opposite_party_designation"
                                                                           ...
                                                                           value="{{ $data->opposite_party_designation }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value="{{ $data->fixed_hearing_court }}">
