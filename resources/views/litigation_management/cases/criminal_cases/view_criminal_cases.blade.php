                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h6 class="text-uppercase text-bold"><u> OPPOSITE PARTY INFORMATION </u>
                                                        <button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#modal-lg-opposition-info" data-toggle="tooltip"
                                                                data-placement="top" title="Update Basic Information"><i class="fas fa-edit"></i></button>
                                                    </h6>
                                                    <table class="table table-bordered table-responsive">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h6 class="text-uppercase text-bold"><u> Case Information </u>
                                                        <button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#modal-lg-case-info" data-toggle="tooltip"
                                                                data-placement="top" title="Update Basic Information"><i class="fas fa-edit"></i></button>
                                                    </h6>
                                                    <table class="table table-bordered table-responsive">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h6 class="text-uppercase text-bold"><u> Lawyers Information </u>
                                                        <button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#modal-lg-lawyers-info" data-toggle="tooltip"
                                                                data-placement="top" title="Update Basic Information"><i class="fas fa-edit"></i></button>
                                                    </h6>
                                                    <table class="table table-bordered table-responsive">
                                                ...
                                                <div class="card-body">
                                                    <h6 class="text-uppercase text-bold">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">Yes/No<button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#modal-lg-case-steps" data-toggle="tooltip"
                                                                data-placement="top" title="Update Basic Information"><i class="fas fa-edit"></i></button></div>
                                                        </div>
                                                    </h6>
                                                    <table class="table table-bordered table-responsive">
