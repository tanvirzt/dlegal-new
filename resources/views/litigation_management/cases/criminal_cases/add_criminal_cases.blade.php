                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="">
                            ...
                            <form action="{{ route('save-criminal-cases') }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="trial_court" class="form-control" rows="3"
                                                              placeholder="">{{old('trial_court')}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <label for="name_of_the_complainant" class="col-sm-4 col-form-label">Name
                                                    of the Complainant</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="name_of_the_complainant"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="complainant_contact_no"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label for="complainant_designation_id" class="col-sm-4 col-form-label">Designation
                                                    of the Complainant</label>
                                                <div class="col-sm-8">
                                                    ...
                                                    <select name="complainant_designation_id"
                                                        ...
                                                        @foreach($designation as $item)
                                                            <option
                                                                value="{{ $item->id }}" {{(old('complainant_designation_id') == $item->id ? 'selected':'')}}>{{ $item->designation_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="accused_name" class="col-sm-4 col-form-label">Name of the
                                                    Accused</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="accused_company_id" class="col-sm-4 col-form-label">Name of
                                            ...
                                            <div class="form-group row">
                                                <label for="accused_address" class="col-sm-4 col-form-label"> Address of
                                                    the Accused </label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="accused_address"
                                                           name="accused_address" value="{{old('accused_address')}}">
                                                    @error('accused_address')<span
                                                        class="text-danger">{{$message}}</span>@enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="accused_contact_no" class="col-sm-4 col-form-label"> Accused
                                                    Contact No. </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="    " class="col-sm-4 col-form-label"> Summary of Facts &
                                                    Alligation </label>
                                                <div class="col-sm-8">
