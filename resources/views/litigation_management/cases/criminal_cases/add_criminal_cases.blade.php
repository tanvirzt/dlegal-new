                                ...
                                <div class="">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="legal_issue_id" class="col-sm-4 col-form-label">Legal Issue</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="legal_service_id" class="col-sm-4 col-form-label">Legal Service</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="complainant_informant_name" class="col-sm-4 col-form-label">Complainant/Informant Name </label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="complainant_informant_name"
                                            ...
                                            <div class="form-group row">
                                                <label for="accused_name" class="col-sm-4 col-form-label">Accused Name </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="in_favour_of" class="col-sm-4 col-form-label">In favour of </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="contact_person_details" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('contact_person_details')}}</textarea>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="coordinator_tadbirkar_ddw"
                                                       class="col-sm-4 col-form-label"> Coordinator/Tadbirkar (DD&W) </label>
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           id="coordinator_tadbirkar_ddw"
                                                           name="coordinator_tadbirkar_ddw"
                                                           value="{{old('coordinator_tadbirkar_ddw')}}">
                                                    @error('coordinator_tadbirkar_ddw')<span
                                                        class="text-danger">{{$message}}</span>@enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="assigned_lawyer" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('assigned_lawyer')}}</textarea>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="case_status_dd_id"
                                                       class="col-sm-4 col-form-label">Status (DD)</label>
                                                <div class="col-sm-8">
                                                    <select name="case_status_dd_id"
                                                            class="form-control select2">
                                                        <option value="">Select</option>
                                                        @foreach($case_status as $item)
                                                            <option
                                                                value="{{ $item->id }}" {{(old('case_status_dd_id') == $item->id ? 'selected':'')}}>{{ $item->case_status_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('case_status_dd_id')<span
                                                        class="text-danger">{{$message}}</span>@enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="law" class="col-sm-4 col-form-label">
                                                    Law </label>
                                                <div class="col-sm-8">
                                                    <textarea name="law" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('law')}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <label for="section" class="col-sm-4 col-form-label">
                                                    Section </label>
                                                <div class="col-sm-8">
                                                    <textarea name="section" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('section')}}</textarea>
                                                    @error('section')<span
                                                        class="text-danger">{{$message}}</span>@enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="date_of_filing" class="col-sm-4 col-form-label">Case Filing Date</label>
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           id="date_of_filing"
                                                           name="date_of_filing"
                                            ...
                                            <div class="form-group row">
                                                <label for="complainant_informant_name"
                                                       class="col-sm-4 col-form-label">
                                                    Complainant/Informant Name </label>
                                                <div class="col-sm-8">
                                                    <textarea name="complainant_informant_name" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('complainant_informant_name')}}</textarea>
                                                    @error('complainant_informant_name')<span
                                                        class="text-danger">{{$message}}</span>@enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="complainant_informant_representative" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('complainant_informant_representative')}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <label for="case_infos_accused_name"
                                                    ...
                                                    Accused Name </label>
                                                <div class="col-sm-8">
                                                    <textarea name="case_infos_accused_name" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('case_infos_accused_name')}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="case_infos_accused_representative" class="form-control"
                                                              rows="3"
                                                              placeholder="">{{old('case_infos_accused_representative')}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <label for="date_of_bill"
                                                    ...
                                                    Date of Bill </label>
                                                <div class="col-sm-8">
                                                    <textarea name="date_of_bill" class="form-control" rows="3"
                                                              placeholder="">{{old('date_of_bill')}}</textarea>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           ...
                                                           value="{{old('judgement_date_of_filing')}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           ...
                                                           value="{{old('date_of_court_transfer')}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           ...
                                                           value="{{old('date_of_charge_framed')}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           ...
                                                           value="{{old('date_of_witness_from')}}">
                                            ...
                                            <div class="form-group row">
                                                <label for="date_of_judgement_order"
                                                       class="col-sm-4 col-form-label"> Date of Judgement & Order </label>
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           id="date_of_judgement_order"
                                                           name="date_of_judgement_order"
                                                           value="{{old('date_of_judgement_order')}}">
