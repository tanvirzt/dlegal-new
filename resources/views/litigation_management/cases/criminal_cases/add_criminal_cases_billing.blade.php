                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="bill_submitted" class="col-sm-4 col-form-label">Bill Submitted</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="bill_submitted" name="bill_submitted" value="{{old('bill_submitted')}}">
                                                    @error('bill_submitted')<span class="text-danger">{{$message}}</span>@enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="payment_received" class="col-sm-4 col-form-label">Payment Received</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="payment_received" name="payment_received" value="{{old('payment_received')}}">
