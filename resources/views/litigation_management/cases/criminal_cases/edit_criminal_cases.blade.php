            ...
            <div class="container-fluid py-2">
                ...
                <h3 class="mt-2" style="color: #FF7034;">
                    ...
                    {!! $case_no_data->case_infos_case_no
                        ? $case_no_data->case_infos_case_title_name .
                            ' ' .
                            $case_no_data->case_infos_case_no .
                            '<span class="text-lowercase" style="font-size: 17px;"> of </span>' .
                            $case_no_data->case_infos_case_year
                        : '' !!}@if ($case_no_data->sub_seq_case_title_name != null)
                        ,
                    @endif
                                                ...
                                                <div class="row original_case">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h6 class="text-uppercase text-bold"><u> Primary
                                                                            Information </u>
                                                                    </h6>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="legal_issue_id"
                                                                            class="col-sm-4 col-form-label">Legal
                                                                            Issue</label>
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="complainant_informant_id"
                                                                            class="col-sm-4 col-form-label">Complainant/Informant
                                                                            Name</label>
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="in_favour_of_id"
                                                                            class="col-sm-4 col-form-label">In favour
                                                                            of </label>
                                                                        <div class="col-sm-8">
                                                                            <select name="in_favour_of_id"
                                                                                class="form-control select2">
                                                                                <option value="">Select</option>
                                                                                @foreach ($in_favour_of as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                                        {{ $data->in_favour_of_id == $item->id ? 'selected' : '' }}>
                                                                                        {{ $item->in_favour_of_name }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <span class="date_span">
                                                                                <input type="date"
                                                                                    ...
                                                                                    onchange="setCorrect(this,'xTime');"><input
                                                                                    type="text" id="xTime"
                                                                                    name="next_date"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <span class="date_span">
                                                                                <input type="date"
                                                                                    class="xDateContainer date_first_input"
                                                                                    onchange="setCorrect(this,'xTime2');"><input
                                                                                    type="text" id="xTime2"
                                                                                    name="received_date"
                                                                                    @if ($data->received_date != null) value="{{ date('d-m-Y', strtotime($data->received_date)) }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input"
                                                                                    tabindex="-1"><span
                                                                                    class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="referrer_id"
                                                                            class="col-sm-4 col-form-label"> Referrer Name
                                                                        </label>
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="received_by_id"
                                                                            class="col-sm-4 col-form-label"> Received By
                                                                        </label>
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                    ...
                                                                    <h6 class="text-uppercase text-bold"><u> Case File
                                                                            Location </u>
                                                                    </h6>
                                                                    <div class="form-group row">
                                                                        <label for="cabinet_id"
                                                                            class="col-sm-4 col-form-label"> Cabinet Name
                                                                        </label>
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h6 class="text-uppercase text-bold"><u> Client
                                                                            Information </u>
                                                                    </h6>
                                                                    <div class="form-group row">
                                                                        <label for="client_party_id"
                                                                            class="col-sm-4 col-form-label">Client(Which
                                                                            Party)</label>
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <select name="client_category_id"
                                                                                ...
                                                                                @foreach ($client_category as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                                        ...
                                                                                        {{ ucfirst($item->client_category_name) }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                            ...
                                                                            <select name="client_subcategory_id"
                                                                                ...
                                                                                @foreach ($existing_client_subcategory as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                                        ...
                                                                                        {{ ucfirst($item->client_subcategory_name) }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div
                                                                                        class="input-group hdtuto_client control-group increment_client">
                                                                                        <input type="text"
                                                                                        ...
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-success btn_success_client"
                                                                                                type="button"><i
                                                                                    ...
                                                                                    <div class="clone_client hide">
                                                                                        <div class="hdtuto_client control-group lst input-group"
                                                                                            ...
                                                                                            <div class="input-group-btn">
                                                                                                <button
                                                                                                    class="btn btn-danger btn_danger_client"
                                                                                                    type="button"><i
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="client_business_name"
                                                                            class="col-sm-4 col-form-label">Client Business
                                                                            Name</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="client_group_id"
                                                                            class="col-sm-4 col-form-label">Client Group
                                                                            Name</label>
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="client_mobile" name="client_mobile"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="client_representative_name"
                                                                            class="col-sm-4 col-form-label">Representative
                                                                            Name</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <select
                                                                                        name="client_coordinator_tadbirkar_id"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="client_coordinator_details"
                                                                            class="col-sm-4 col-form-label"> Coordinator
                                                                            Details </label>
                                                                        <div class="col-sm-8">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h6 class="text-uppercase text-bold"><u> Opposite Party
                                                                            Information </u></h6>
                                                                    <div class="form-group row">
                                                                        <label for="opposition_party_id"
                                                                            class="col-sm-4 col-form-label">Opposition(Which
                                                                            Party)</label>
                                                                        <div class="col-sm-8">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div
                                                                                        class="input-group hdtuto_opposition control-group increment_opposition">
                                                                                        <input type="text"
                                                                                            name="opposition_write[]"
                                                                                            class="myfrm form-control col-12"
                                                                                            placeholder="Client Name"
                                                                                            value="{{ rtrim($data->opposition_write, ', ') }}">
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-success btn_success_opposition"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                            </button>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="clone_opposition hide">
                                                                                        <div class="hdtuto_opposition control-group lst input-group"
                                                                                            ...
                                                                                            <div class="input-group-btn">
                                                                                                <button
                                                                                                    class="btn btn-danger btn_danger_opposition"
                                                                                                    type="button"><i
                                                                                                        class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                    -
                                                                                                </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="opposition_business_name"
                                                                            class="col-sm-4 col-form-label">Opposition
                                                                            Business Name</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="opposition_business_name"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="opposition_mobile"
                                                                            class="col-sm-4 col-form-label">Opposition
                                                                            Mobile</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="opposition_mobile"
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <select name="opposition_district_id"
                                                                                        ...
                                                                                        @foreach ($opposition_existing_district as $item)
                                                                                            <option
                                                                                                value="{{ $item->id }}"
                                                                                                {{ $data->opposition_district_id == $item->id ? 'selected' : '' }}>
                                                                                                {{ ucfirst($item->district_name) }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <select name="opposition_thana_id"
                                                                                        ...
                                                                                        @foreach ($opposition_existing_thana as $item)
                                                                                            <option
                                                                                                value="{{ $item->id }}"
                                                                                                {{ $data->opposition_thana_id == $item->id ? 'selected' : '' }}>
                                                                                                {{ ucfirst($item->thana_name) }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="opposition_representative_name"
                                                                            class="col-sm-4 col-form-label">Representative
                                                                            Name</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="opposition_representative_name"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <select
                                                                                        name="opposition_coordinator_tadbirkar_id"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div
                                                                                ...
                                                                                <span class="d-flex">
                                                                                    <input type="hidden"
                                                                                        name="received_documents_sections[]"
                                                                                    ...
                                                                                    <select
                                                                                        name="received_documents_type_id[]"
                                                                                    ...
                                                                                    <div class="input-group-btn">
                                                                                        <button
                                                                                            class="btn btn-success btn_success_received_documents_edit"
                                                                                            type="button"><i
                                                                                                class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                        </button>
                                                                                    </div>
                                                                            ...
                                                                            <div
                                                                                class="clone_received_documents @if (count($received_documents_explode) <= 1) hide @endif">
                                                                                @php
                                                                            ...
                                                                            <div
                                                                                class="clone_received_documents_edit hide">
                                                                                <div class="hdtuto_received_documents control-group input-group"
                                                                                    style="margin-top:10px">
                                                                                    <input type="hidden"
                                                                                        name="received_documents_sections[]"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <div
                                                                                ...
                                                                                <input type="hidden"
                                                                                    name="required_wanting_documents_sections[]"
                                                                                    class="myfrm form-control mr-2"
                                                                                    value="required_wanting_documents_sections">
                                                                                <select
                                                                                    name="required_wanting_documents_id[]"
                                                                                    class="form-control mr-3">
                                                                                    <option value="">Select</option>
                                                                                    @foreach ($documents as $item)
                                                                                        <option
                                                                                ...
                                                                                <input type="text"
                                                                                    name="required_wanting_documents[]"
                                                                                    class="myfrm form-control mr-2"
                                                                                ...
                                                                                <select
                                                                                    name="required_wanting_documents_type_id[]"
                                                                                    class="form-control mr-3 ml-2">
                                                                                    <option value="">Select</option>
                                                                                    @foreach ($documents_type as $item)
                                                                                        <option
                                                                                ...
                                                                                <div class="input-group-btn">
                                                                                    <button
                                                                                        class="btn btn-success btn_success_required_wanting_documents_edit"
                                                                                        type="button"><i
                                                                                            class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                    </button>
                                                                                </div>
                                                                            ...
                                                                            <div
                                                                                class="clone_required_wanting_documents_edit hide">
                                                                                <div class="hdtuto_required_wanting_documents control-group input-group"
                                                                                    style="margin-top:10px">
                                                                                    <input type="hidden"
                                                                                        name="required_wanting_documents_sections[]"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h6 class="text-uppercase text-bold"><u> Case
                                                                            Information </u>
                                                                    </h6>
                                                                    <div class="form-group row">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_type_id"
                                                                            class="col-sm-4 col-form-label">Case Type
                                                                        </label>
                                                                        <div class="col-sm-8">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_infos_court_short_id"
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <select
                                                                                        name="case_infos_court_short_id[]"
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div
                                                                                        class="input-group hdtuto_court_short control-group increment_court_short">
                                                                                        <input type="text"
                                                                                            name="court_short_write[]"
                                                                                            class="myfrm form-control col-12"
                                                                                            placeholder="Court Name(Short)"
                                                                                            value="{{ $data->court_short_write }}">
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-success btn_success_court_short"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                            </button>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="clone_court_short hide">
                                                                                        <div class="hdtuto_court_short control-group lst input-group"
                                                                                            ...
                                                                                            <div class="input-group-btn">
                                                                                                <button
                                                                                                    class="btn btn-danger btn_danger_court_short"
                                                                                                    type="button"><i
                                                                                                        class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                    -
                                                                                                </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <select
                                                                                name="case_infos_sub_seq_case_title_id"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div
                                                                                ...
                                                                                <div class="row" style="">
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="case_infos_sub_seq_case_no[]"
                                                                                        placeholder="Case No."
                                                                                        value="{{ rtrim($data->case_infos_sub_seq_case_no, ', ') }}">
                                                                                    <input type="text"
                                                                                        class="form-control col-5 ml-0"
                                                                                        id="case_infos_sub_seq_case_year"
                                                                                        name="case_infos_sub_seq_case_year[]"
                                                                                        placeholder="Case Year"
                                                                            ...
                                                                            <div
                                                                                class="clone_case_infos_sub_seq_case_no hide ">
                                                                                <div class="hdtuto_case_infos_sub_seq_case_no control-group lst input-group ml-2"
                                                                                    ...
                                                                                    <div class="row" style="">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            ...
                                                                                            placeholder="Case Year">
                                                                                        <div
                                                                                            class="input-group-btn col-2">
                                                                                            <button
                                                                                                class="btn btn-danger btn_danger_case_infos_sub_seq_case_no ml-2"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                -
                                                                                            </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_infos_sub_seq_court_id"
                                                                            class="col-sm-4 col-form-label"> Sub-Seq.
                                                                            Court </label>
                                                                        <div class="col-sm-8">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_infos_sub_seq_court_short_id"
                                                                            class="col-sm-4 col-form-label">Sub-Seq.
                                                                            Court(Short)</label>
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <select
                                                                                        name="case_infos_sub_seq_court_short_id[]"
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="sub_seq_court_short_write[]"
                                                                                            class="myfrm form-control col-12"
                                                                                            placeholder="Sub-Seq. Court Name(Short)"
                                                                                            value="{{ $data->sub_seq_court_short_write }}">
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-success btn_success_sub_seq_court_short"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                            </button>
                                                                                        </div>
                                                                                    ...
                                                                                    <div
                                                                                        class="clone_sub_seq_court_short hide">
                                                                                        <div class="hdtuto_sub_seq_court_short control-group lst input-group"
                                                                                            ...
                                                                                            <div class="input-group-btn">
                                                                                                <button
                                                                                                    class="btn btn-danger btn_danger_sub_seq_court_short"
                                                                                                    type="button"><i
                                                                                                        class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                    -
                                                                                                </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div
                                                                                        class="input-group hdtuto_law control-group increment_law">
                                                                                        <input type="text"
                                                                                            name="law_write[]"
                                                                                            class="myfrm form-control col-12"
                                                                                        ...
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-success btn_success_law"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                            </button>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="clone_law hide">
                                                                                        <div class="hdtuto_law control-group lst input-group"
                                                                                            ...
                                                                                            <div class="input-group-btn">
                                                                                                <button
                                                                                                    class="btn btn-danger btn_danger_law"
                                                                                                    type="button"><i
                                                                                                        class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                    -
                                                                                                </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div
                                                                                        class="input-group hdtuto_section control-group increment_section">
                                                                                        <input type="text"
                                                                                            name="section_write[]"
                                                                                            class="myfrm form-control col-12"
                                                                                        ...
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-success btn_success_section"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                            </button>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="clone_section hide">
                                                                                        <div class="hdtuto_section control-group lst input-group"
                                                                                            ...
                                                                                            <div class="input-group-btn">
                                                                                                <button
                                                                                                    class="btn btn-danger btn_danger_section"
                                                                                                    type="button"><i
                                                                                                        class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                    -
                                                                                                </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="date_of_filing"
                                                                            class="col-sm-4 col-form-label">Case Filing
                                                                            Date</label>
                                                                        <div class="col-sm-8">
                                                                            <span class="date_span">
                                                                                <input type="date"
                                                                                    class="xDateContainer date_first_input"
                                                                                    onchange="setCorrect(this,'xTime4');"><input
                                                                                    type="text" id="xTime4"
                                                                                    name="date_of_filing"
                                                                                    @if ($data->date_of_filing != null) value="{{ $data->date_of_filing }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input"
                                                                                    tabindex="-1"><span
                                                                                    class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div
                                                                                class="input-group hdtuto_complainant control-group increment_complainant">
                                                                                <input type="text"
                                                                                ...
                                                                                <div class="input-group-btn">
                                                                                    <button
                                                                                        class="btn btn-success btn_success_complainant"
                                                                                        type="button"><i
                                                                                            class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                    </button>
                                                                                </div>
                                                                            ...
                                                                            <div class="clone_complainant hide">
                                                                                <div class="hdtuto_complainant control-group lst input-group"
                                                                                    ...
                                                                                    <div class="input-group-btn">
                                                                                        <button
                                                                                            class="btn btn-danger btn_danger_complainant"
                                                                                            type="button"><i
                                                                                                class="fldemo glyphicon glyphicon-remove"></i>
                                                                                            -
                                                                                        </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="text"
                                                                                    name="complainant_informant_representative[]"
                                                                                    value="{{ rtrim($data->complainant_informant_representative, ', ') }}"
                                                                                    class="myfrm form-control">
                                                                                <div class="input-group-btn">
                                                                                    <button
                                                                                        class="btn btn-success btn_success_complainant_representative"
                                                                                        type="button"><i
                                                                                            class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                    </button>
                                                                                </div>
                                                                            ...
                                                                            <div
                                                                                class="clone_complainant_representative hide">
                                                                                <div class="hdtuto_complainant_representative control-group lst input-group"
                                                                                    ...
                                                                                    <div class="input-group-btn">
                                                                                        <button
                                                                                            class="btn btn-danger btn_danger_complainant_representative"
                                                                                            type="button"><i
                                                                                                class="fldemo glyphicon glyphicon-remove"></i>
                                                                                            -
                                                                                        </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div
                                                                                class="input-group hdtuto_accused control-group increment_accused">
                                                                                <input type="text"
                                                                                ...
                                                                                <div class="input-group-btn">
                                                                                    <button
                                                                                        class="btn btn-success btn_success_accused"
                                                                                        type="button"><i
                                                                                            class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                    </button>
                                                                                </div>
                                                                            ...
                                                                            <div class="clone_accused hide">
                                                                                <div class="hdtuto_accused control-group lst input-group"
                                                                                    ...
                                                                                    <div class="input-group-btn">
                                                                                        <button
                                                                                            class="btn btn-danger btn_danger_accused"
                                                                                            type="button"><i
                                                                                                class="fldemo glyphicon glyphicon-remove"></i>
                                                                                            -
                                                                                        </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="text"
                                                                                    name="case_infos_accused_representative[]"
                                                                                    value="{{ rtrim($data->case_infos_accused_representative, ', ') }}"
                                                                                    class="myfrm form-control">
                                                                                <div class="input-group-btn">
                                                                                    <button
                                                                                        class="btn btn-success btn_success_accused_representative"
                                                                                        type="button"><i
                                                                                            class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                    </button>
                                                                                </div>
                                                                            ...
                                                                            <div
                                                                                class="clone_accused_representative hide">
                                                                                <div class="hdtuto_accused_representative control-group lst input-group"
                                                                                    ...
                                                                                    <div class="input-group-btn">
                                                                                        <button
                                                                                            class="btn btn-danger btn_danger_accused_representative"
                                                                                            type="button"><i
                                                                                                class="fldemo glyphicon glyphicon-remove"></i>
                                                                                            -
                                                                                        </button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="prosecution_witness"
                                                                            class="col-sm-4 col-form-label">Prosecution
                                                                            Witnesses</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="defense_witness"
                                                                            class="col-sm-4 col-form-label">Defense
                                                                            Witnesses</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="defense_witness"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <select
                                                                                        name="case_infos_allegation_claim_id"
                                                                                        class="form-control select2">
                                                                                        <option value="">Select
                                                                                        </option>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="recovery_seizure_articles"
                                                                            class="col-sm-4 col-form-label">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h6 class="text-uppercase text-bold"><u> Letter /
                                                                            Notice / Reply </u></h6>
                                                                    <h6 class="text-uppercase text-bold">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4 text-center ml-3">
                                                                                Document Name</div>
                                                                            <div class="col-md-3 text-center">Particulars
                                                                            </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <div
                                                                                class="input-group hdtuto_letter_notice control-group increment_letter_notice">
                                                                                <input type="hidden"
                                                                                    name="letter_notice_sections[]"
                                                                                    class="myfrm form-control mr-2 col-md-4"
                                                                                    value="letter_notice_sections">
                                                                                <input type="date"
                                                                                    name="letter_notice_date[]"
                                                                                    class="myfrm form-control mr-2 col-md-4"
                                                                                    value="{{ !empty($letter_notice_explode[0]['letter_notice_date']) ? $letter_notice_explode[0]['letter_notice_date'] : '' }}">
                                                                                <select
                                                                                    name="letter_notice_documents_id[]"
                                                                                ...
                                                                                <input type="text"
                                                                                    name="letter_notice_documents_write[]"
                                                                                    class="myfrm form-control mr-2 col-md-4"
                                                                                ...
                                                                                <div class="input-group-btn">
                                                                                    <button
                                                                                        class="btn btn-success btn_success_letter_notice_edit"
                                                                                        type="button"><i
                                                                                            class="fldemo glyphicon glyphicon-plus"></i>+
                                                                                    </button>
                                                                                </div>
                                                                            ...
                                                                            <div
                                                                                class="clone_letter_notice @if (count($letter_notice_explode) <= 1) hide @endif">
                                                                                @php
                                                                                ...
                                                                                @foreach ($letter_notice_explode as $datas)
                                                                                    <div class="hdtuto_letter_notice control-group lst input-group"
                                                                                        ...
                                                                                        <div class="input-group-btn">
                                                                                            <button
                                                                                                class="btn btn-danger btn_danger_letter_notice"
                                                                                                type="button"><i
                                                                                                    class="fldemo glyphicon glyphicon-remove"></i>
                                                                                                -
                                                                                            </button>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_filing"
                                                                            class="col-sm-3 col-form-label"> Filing
                                                                            Date </label>
                                                                        <div class="col-sm-3">
                                                                            <input type="text" class="form-control"
                                                                                id="case_steps_filing"
                                                                                name="case_steps_filing"
                                                                                value="{{ $edit_case_steps->case_steps_filing }}"
                                                                                readonly>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="taking_cognizance"
                                                                            class="col-sm-3 col-form-label"> Taking
                                                                            Cognizance </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                ...
                                                                                <input type="text"
                                                                                    id="taking_cognizance"
                                                                                    name="taking_cognizance"
                                                                                    class="date_second_input_steps"
                                                                                    @if ($edit_case_steps->taking_cognizance) value="{{ $edit_case_steps->taking_cognizance }}" @else value="dd-mm-yyyy" @endif
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                ...
                                                                                <input type="text"
                                                                                    id="arrest_surrender_cw"
                                                                                    name="arrest_surrender_cw"
                                                                                    @if ($edit_case_steps->arrest_surrender_cw) value="{{ $edit_case_steps->arrest_surrender_cw }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_bail"
                                                                            class="col-sm-3 col-form-label"> Bail </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                    class="xDateContainer date_first_input"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_bail"
                                                                                    name="case_steps_bail"
                                                                                    @if ($edit_case_steps->case_steps_bail) value="{{ $edit_case_steps->case_steps_bail }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_court_transfer"
                                                                            class="col-sm-3 col-form-label"> Court
                                                                            Transfer </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_court_transfer"
                                                                                    name="case_steps_court_transfer"
                                                                                    @if ($edit_case_steps->case_steps_court_transfer) value="{{ $edit_case_steps->case_steps_court_transfer }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <select
                                                                                name="case_steps_court_transfer_type_id"
                                                                                class="form-control">
                                                                                <option value="">Select</option>
                                                                                @foreach ($documents_type as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_charge_framed"
                                                                            class="col-sm-3 col-form-label"> Charge Framed
                                                                        </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_charge_framed"
                                                                                    name="case_steps_charge_framed"
                                                                                    @if ($edit_case_steps->case_steps_charge_framed) value="{{ $edit_case_steps->case_steps_charge_framed }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <select
                                                                                name="case_steps_charge_framed_type_id"
                                                                                class="form-control">
                                                                                <option value="">Select</option>
                                                                                @foreach ($documents_type as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_witness_from"
                                                                            class="col-sm-3 col-form-label"> Witness
                                                                            (From) </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_witness_from"
                                                                                    name="case_steps_witness_from"
                                                                                    @if ($edit_case_steps->case_steps_witness_from) value="{{ $edit_case_steps->case_steps_witness_from }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_witness_to"
                                                                            class="col-sm-3 col-form-label"> Witness (To)
                                                                        </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_witness_to"
                                                                                    name="case_steps_witness_to"
                                                                                    @if ($edit_case_steps->case_steps_witness_to) value="{{ $edit_case_steps->case_steps_witness_to }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_argument"
                                                                            class="col-sm-3 col-form-label"> Argument
                                                                        </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_argument"
                                                                                    name="case_steps_argument"
                                                                                    @if ($edit_case_steps->case_steps_argument) value="{{ $edit_case_steps->case_steps_argument }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_judgement_order"
                                                                            class="col-sm-3 col-form-label"> Judgement &
                                                                            Order </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_judgement_order"
                                                                                    name="case_steps_judgement_order"
                                                                                    @if ($edit_case_steps->case_steps_judgement_order) value="{{ $edit_case_steps->case_steps_judgement_order }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <select
                                                                                name="case_steps_judgement_order_type_id"
                                                                                class="form-control">
                                                                                <option value="">Select</option>
                                                                                @foreach ($documents_type as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="case_steps_summary_of_cases"
                                                                            class="col-sm-3 col-form-label"> Summary of
                                                                            Case </label>
                                                                        <div class="col-sm-3">
                                                                            <span class="date_span_steps">
                                                                                <input type="date"
                                                                                ...
                                                                                <input type="text"
                                                                                    id="case_steps_summary_of_cases"
                                                                                    name="case_steps_summary_of_cases"
                                                                                    @if ($edit_case_steps->case_steps_summary_of_cases) value="{{ $edit_case_steps->case_steps_summary_of_cases }}" @else value="dd-mm-yyyy" @endif
                                                                                    class="date_second_input_steps"
                                                                                    tabindex="-1">
                                                                                <span class="date_second_span"
                                                                                    tabindex="-1">&#9660;</span>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <select
                                                                                name="case_steps_summary_of_cases_type_id"
                                                                                class="form-control">
                                                                                <option value="">Select</option>
                                                                                @foreach ($documents_type as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="lawyers_remarks"
                                                                            class="col-sm-4 col-form-label"> Remarks
                                                                        </label>
                                                                        <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div
                                                                class="input-group hdtuto_files control-group increment_files">
                                                                ...
                                                                <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <span class="date_span_status">
                                                                                <input type="date"
                                                                                    ...
                                                                                    type="text"
                                                                                    id="updated_order_date"
                                                                                    name="updated_order_date"
                                                                                    @if (!empty($previous_activity->updated_next_date)) value="{{ date('d-m-Y', strtotime($previous_activity->updated_next_date)) }}" @endif
                                                                                    value="dd-mm-yyyy"
                                                                                    class="date_second_input"
                                                                                    tabindex="-1"><span
                                                                                    class="date_second_span"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="court_proceedings_id"
                                                                            class="col-md-4 col-form-label"> Court
                                                                            Proceeding
                                                                        </label>
                                                                        <div class="col-md-8">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <select name="court_proceedings_id[]"
                                                                                        ...
                                                                                        @foreach ($court_proceeding as $item)
                                                                                            <option
                                                                                                value="{{ $item->court_proceeding_name }}"
                                                                                                {{ old('court_proceedings_id') == $item->id ? 'selected' : '' }}>
                                                                                                {{ $item->court_proceeding_name }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="updated_index_fixed_for_id"
                                                                            class="col-md-4 col-form-label"> Next Date
                                                                            Fixed For
                                                                        </label>
                                                                        <div class="col-md-8">
                                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="updated_remarks"
                                                                            class="col-sm-4 col-form-label"> Steps To be
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="start_time"
                                                                            class="col-sm-4 col-form-label">Start
                                                                            Time</label>
                                                                        <div class="col-sm-8">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="end_time"
                                                                            class="col-sm-4 col-form-label">End
                                                                            Time</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="datetime-local"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="setup_hours"
                                                                            class="col-sm-4 col-form-label">Time
                                                                            Spent</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="setup_hours" name="setup_hours"
                                                                                readonly>
                                                                            @error('setup_hours')
                                                                                <span
                                                                                    class="text-danger">{{ $message }}</span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="time_spend_manual"
                                                                            class="col-sm-4 col-form-label">Time
                                                                            Spent</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control"
                                                                                id="time_spend_manual"
