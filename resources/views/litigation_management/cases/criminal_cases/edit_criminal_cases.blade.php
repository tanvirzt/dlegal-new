                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <select name="case_subcategory_id"
                                                                        ...
                                                                        @foreach($existing_case_subcategory as $item)
                                                                            <option
                                                                                value="{{ $item->id }}" {{($data->case_category_id == $item->id ? 'selected':'')}}>{{ $item->case_subcategory }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="trial_court"
                                                                       class="col-sm-4 col-form-label">Trial
                                                                    Court</label>
                                                                <div class="col-sm-8">
                                                    <textarea name="trial_court" class="form-control" rows="3"
                                                              placeholder="">{{ $data->trial_court }}</textarea>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                           id="subsequent_case_no"
                                                                           name="subsequent_case_no"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="company_organization_id"
                                                                       class="col-sm-4 col-form-label">
                                                                    Company/Organization </label>
                                                                <div class="col-sm-8">
                                                                    <select name="company_organization_id"
                                                                            class="form-control select2">
                                                                        <option value="">Select</option>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="district_id"
                                                                        ...
                                                                        @foreach ($existing_district as $item)
                                                                            <option
                                                                                value="{{ $item->id }}" {{($data->district_id == $item->id ? 'selected':'')}}>{{ ucfirst($item->district_name) }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    @error('name_of_the_complainant')<span
                                                                        class="text-danger">{{$message}}</span>@enderror
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    @error('complainant_contact_no')<span
                                                                        class="text-danger">{{$message}}</span>@enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <select name="complainant_designation_id"
                                                                        ...
                                                                        @foreach($designation as $item)
                                                                            <option
                                                                                value="{{ $item->id }}" {{($data->complainant_designation_id == $item->id ? 'selected':'')}}>{{ $item->designation_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('complainant_designation_id')<span
                                                                        class="text-danger">{{$message}}</span>@enderror
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="accused_company_id"
                                                                        ...
                                                                        @foreach($company as $item)
                                                                            <option
                                                                                value="{{ $item->id }}" {{( $data->accused_company_id == $item->id ? 'selected':'')}}>{{ $item->company_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('accused_company_id')<span
                                                                        class="text-danger">{{$message}}</span>@enderror
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="accused_address"
                                                                       class="col-sm-4 col-form-label"> Address of
                                                                    the Accused </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                           id="accused_address"
