                        ...
                        <div class="">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('edit-labour-cases', $data->id) }}"><button
                                    ...
                                    <table class="table table-responsive table-hover table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th>Name of the 1st Party/Petitioner</th>
                                                <td>{{ $data->name_of_the_first_party }}</td>
                                            </tr>
                                            <tr>
                                                <th>Client Category</th>
                                                <td>{{ $data->client_category_name }}</td>
                                                <th>1st Party/Petitioner Contact No.</th>
                                                <td>{{ $data->first_party_contact_no }}</td>
                                            </tr>
                                            <tr>
                                                <th>Client Subcategory</th>
                                                <td>{{ $data->client_subcategory_name }}</td>
                                                <th>Designation of the 1st Party/Petitioner</th>
                                            ...
                                            <tr>
                                                ...
                                                <th>Name of the 2nd Party/Opposite Party</th>
                                                <td>{{ $data->second_party_name }}</td>
                                            </tr>
                                            <tr>
                                                <th>Type of Cases</th>
                                                <td>{{ $data->case_types_name }}</td>
                                                <th>Address of 2nd Party/Opposite Party</th>
                                                <td> {{ $data->second_party_address }} </td>
                                            </tr>
                                            <tr>
                                                <th>Trial Court</th>
                                ...
                                <div class="card-body">
                                    <table id="data_table" class="table dataTable no-footer dtr-inline">
                                        ...
                                        <tbody>
                                        @foreach($labour_cases_files as $files)
                                            <tr>
