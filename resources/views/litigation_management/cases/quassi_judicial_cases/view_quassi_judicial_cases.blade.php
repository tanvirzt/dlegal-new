                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Special / Quassi-Judicial Cases Details</h3>
                                <div class="float-right">
                                    <a class="btn btn-info"
                                        href="{{ route('edit-quassi-judicial-cases', $data->id) }}"> Edit </a>
                                </div>
                            </div>
                                <div class="card-body">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title" id="heading">Special / Quassi-Judicial Cases Files</h3>
                                </div>
                                <div class="card-body">
                                    <table id="data_table" class="table dataTable no-footer dtr-inline">
                                        ...
                                        <tbody>
                                        @foreach($quassi_judicial_cases_files as $files)
                                            <tr>
                                                <td class="table_text_center">
                                                    {{ $files->uploaded_document }}
                                                </td>
                                                <td class="table_text_center">
                                                        <a href="{{ route('download-quassi-judicial-cases-files', $files->id) }}"><button class="badge badge-info btn-sm"
                                                        > Download </button></a>
                                                </td>
                                            </tr>
                                        @endforeach
