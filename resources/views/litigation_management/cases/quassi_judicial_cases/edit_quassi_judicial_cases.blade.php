                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="member_no" name="member_no" value="{{ $data->member_no }}">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="thana_id" class="form-control select2" id="thana_id">
                                                                        ...
                                                                        @foreach ($existing_thana as $item)
                                                                            <option value="{{ $item->id }}" {{( $data->thana_id == $item->id ? 'selected':'')}}>{{ ucfirst($item->thana_name) }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="relevant_laws_id" class="col-sm-4 col-form-label"> Relevant Laws </label>
                                                                <div class="col-sm-8">
                                                                    <select name="relevant_laws_id" class="form-control select2">
                                                                        <option value="">Select</option>
                                                                        @foreach($law as $item)
                                                                            <option value="{{ $item->id }}" {{( $data->relevant_laws_id == $item->id ? 'selected':'')}}>{{ $item->law_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('relevant_laws_id')<span class="text-danger">{{$message}}</span>@enderror
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="relevant_sections_id" class="form-control select2">
                                                                        ...
                                                                        @foreach($section as $item)
                                                                            <option value="{{ $item->id }}" {{( $data->relevant_sections_id == $item->id ? 'selected':'')}}>{{ $item->section_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="alligation" name="alligation" value="{{ $data->alligation }}">
