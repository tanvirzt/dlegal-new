                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <a class="leading-normal inline-flex items-center font-normal spark-button-focus h-8 text-md px-4 bg-transparent border-0 border-solid text-blue-700 hover:text-blue-800 active:text-blue-700 rounded-md"
                                    type="button" href="{{ route('quassi-judicial-cases') }}" aria-disabled="false"
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <ul class="nav custom_top_tab">
                                            <li class="">
                                                <a data-toggle="tab" href="#home" class="active">Edit Special /
                                                    Quassi-Judicial Cases</a>
                                            </li>
                                            <li class="">
                                    ...
                                    <div class="float-right">
                                        <a href="{{ route('view-quassi-judicial-cases', $data->id) }}"><button
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="date_of_case_received"
                                                                    class="col-sm-4 col-form-label"> Date of Case Received
                                                                </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="case_category_nature_id"
                                                                    class="col-sm-4 col-form-label"> Case Category </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $data->subsequent_case_no }}">
                                                                    @error('subsequent_case_no')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="branch_id" class="col-sm-4 col-form-label">
                                                                    Branch </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="member_no"
                                                                    class="col-sm-4 col-form-label">Member No.</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="member_no"
                                                                        name="member_no" value="{{ $data->case_no }}">
                                                                    @error('member_no')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="program_id" class="col-sm-4 col-form-label">
                                                                    Program </label>
                                                                <div class="col-sm-8">
                                                                    <select name="program_id" class="form-control select2">
                                                                        ...
                                                                        @foreach ($program as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->program_id == $item->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="police_station"
                                                                    class="col-sm-4 col-form-label">Police Station</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="alligation_id" class="col-sm-4 col-form-label">
                                                                    Alligation </label>
                                                                <div class="col-sm-8">
                                                                    <select name="alligation_id"
                                                                        class="form-control select2">
                                                                        <option value="">Select</option>
                                                                        @foreach ($alligation as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->alligation_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->alligation_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('alligation_id')
                                                                        <span
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="complainant_contact_no"
                                                                    class="col-sm-4 col-form-label"> Complainant Contact
                                                                    No. </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="opposite_party_name"
                                                                    class="col-sm-4 col-form-label"> Name of the Opposite
                                                                    Party </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="opposite_party_name" name="opposite_party_name"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="opposite_party_address"
                                                                    class="col-sm-4 col-form-label"> Address of Opposite
                                                                    Party </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="accused_name" name="accused_name"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="accused_company_id"
                                                                    class="col-sm-4 col-form-label">Name of the Accused
                                                                    Company</label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="accused_address"
                                                                    class="col-sm-4 col-form-label"> Address of the Accused
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="accused_address" name="accused_address"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="accused_contact_no"
                                                                    class="col-sm-4 col-form-label"> Accused Contact No.
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="accused_contact_no" name="accused_contact_no"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="total_legal_bill_amount"
                                                                    class="col-sm-4 col-form-label">Total Legal Bill Amount
                                                                    and Cost</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <textarea name="missing_documents_evidence"
                                                                        class="form-control" rows="3"
                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    <div id="home" class="tab-pane active">
                                                        ...
                                                        <form
                                                            action="{{ route('update-quassi-judicial-cases-status', $data->id) }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="card-body">
