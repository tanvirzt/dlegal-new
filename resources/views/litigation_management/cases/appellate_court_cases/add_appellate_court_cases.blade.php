                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Add Appellate Court of Bangladesh</h3>
                            </div>


                            <form action="{{ route('save-appellate-court-cases') }}" method="post"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="law_id" class="form-control select2">
                                                            ...
                                                            @foreach($law as $item)
                                                                <option
                                                                    value="{{ $item->id }}" {{(old('law_id') == $item->id ? 'selected':'')}}>{{ $item->law_name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('law_id')<span
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="section_id"
                                                            ...
                                                            @foreach($section as $item)
                                                                <option
                                                                    value="{{ $item->id }}" {{ old('section_id') == $item->id ? 'selected' : '' }}>{{ $item->section_name }}</option>
                                                            @endforeach
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="acd_court_id"
                                                        ...
                                                        @foreach ($court as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('acd_court_id') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->court_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('acd_court_id')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="laws_id" class="form-control select2">
                                                        ...
                                                        @foreach($law as $item)
                                                            <option
                                                                value="{{ $item->id }}" {{(old('laws_id') == $item->id ? 'selected':'')}}>{{ $item->law_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('laws_id')<span
                                                        class="text-danger">{{$message}}</span>@enderror
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"
                                                           ...
                                                           value="{{ old('court_next_steps_date') }}">
