    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"> Appellate Court Division </h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <table id="data_table" class="table dataTable no-footer dtr-inline">
                                        ...
                                        <tbody>
                                        @foreach($appellate_court_cases_files as $files)
                                            <tr>
                            ...
                            <div class="card-header">
                                <h3 class="card-title custom_h3" id="heading">Proceedings Logs <span><b>(Case No: {{ $data->case_no_acd }}, Court Name: {{ $data->acd_court_name }})</b></span></h3>
                            </div>
                            <div class="card-body">
