                            ...
                            <form action="#" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="external_council_name_id"> External Council Name </label>
                                            <input type="text" class="form-control" name="external_council_name_id"
                                        ...
                                        <div class="form-group">
                                            <label for="name_of_the_court_id"> Name of the Court </label>
                                            <input type="text" class="form-control" name="name_of_the_court_id"
                                                   id="name_of_the_court_id">
