                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title" id="heading"> Supreme Court of Bangladesh Files </h3>
                                </div>
                                <div class="card-body">
                                    <table id="data_table" class="table dataTable no-footer dtr-inline">
                                        ...
                                        @foreach($supreme_court_cases_files as $files)
                                            <tr>
                                                ...
                                                <td class="table_text_center">
                                                        <a href="{{ route('download-supreme-court-cases-files', $files->id) }}"><button class="badge badge-info btn-sm"
                                                        > Download </button></a>
                                                </td>
                                            </tr>
                                        @endforeach
