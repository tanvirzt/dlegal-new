                            ...
                            <form action="{{ route('save-billing') }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mr-5 ml-5" style="padding-left: 200px">
                                        <div class="col-md-8  pl-5 pr-5 mr-5 ml-5">
                                                    ...
                                                    <select name="district_id" class="form-control select2" id="district_id"
                                                        ...
                                                        @foreach ($district as $item)
                                                            <option value="{{ $item->id }}"
                                                                ...
                                                                <?php if ($item->id == $data->case_infos_district_id) {
                                                                    echo 'selected';
                                                    ...
                                                    <select name="case_type_id" class="form-control select2"
                                                        ...
                                                        @foreach ($case_types as $item)
                                                            <option value="{{ $item->id }}"
                                                                ...
                                                                <?php if ($item->id == $data->case_category) {
                                                                    echo 'selected';
                                            ...
                                            <div class="form-group row">
                                                <label for="class_of_cases" class="col-sm-4 col-form-label"> Class
                                                    of Cases
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="case_id" class="col-sm-4 col-form-label"> Case No
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            @if (!empty($case_class))
                                                <input type="hidden" class="form-control" id="class_of_cases"
                                                    name="class_of_cases"
                                                    value="{{ $case_class->case_category_id == 'Criminal' || $case_class->case_category_id == 'Civil' ? 'District Court' : '' }}">
                                                <input type="hidden" class="form-control" id="case_no" name="case_no"
                                                    value="{{ $case_class->id }}">
                                            @endif
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="digital_payment_type_id" class="form-control select2"
                                                        ...
                                                        @foreach ($digital_payment_type as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('payment_type') == $item->id ? 'selected' : '' }}>
