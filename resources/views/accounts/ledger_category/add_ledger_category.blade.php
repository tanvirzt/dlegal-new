                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Add Ledger Category</h3>
                            </div>

                            <form action="{{ route('ledger-category.store') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="ledger_category_name">Ledger Category</label>
                                            <input type="text" class="form-control" name="ledger_category_name"
                                                   id="ledger_category_name">
                                            @error('ledger_category_name')<span class="text-danger">{{$message}}</span>@enderror
                                        </div>
