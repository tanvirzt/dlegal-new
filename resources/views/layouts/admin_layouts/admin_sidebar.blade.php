    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcanany
                @canany(['accused-list', 'allegation-claim-list', 'area-list', 'area-list', 'bank-list', 'bank-branch-list', 'bill-type-list', 'bill-particulars-list', 'bill-schedule-list', 'branch-list', 'cabinet-list','case-status-list','case-title-list','case-category-list', 'case-matter-list', 'case-type-list', 'client-group-list', 'client-name-list', 'client-which-party-list', 'complainant-list', 'coordinator-or-tadbirkar-list', 'court-name-list', 'court-order-list', 'court-proceeding-list', 'day-notes-list', 'designation-list', 'documents-list', 'documents-type-list', 'external-council-list', 'internal-council-list', 'in-favour-of-list', 'law-list', 'legal-issue-list', 'legal-service-list', 'mode-of-received-list', 'next-date-fixed-for-list', 'next-day-presence-list', 'opposition-which-party-list', 'particulars-list', 'party-category-list', 'party-subcategory-list', 'payment-type-list', 'payment-mode-list', 'profession-list', 'program-list', 'progress-list', 'referrer-list', 'section-list', 'title-list', 'zone-list', 'floor-list','flat-number-list', 'property-type-list', 'seller-or-buyer-list', 'compliance-category-list', 'compliance-type-list', 'company-type-list','company-list'])
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="nav-icon fas fa-circle"></i>
                            <p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                @canany(['accused-list', 'allegation-claim-list', 'area-list', 'area-list', 'bank-list', 'bank-branch-list', 'bill-type-list', 'bill-particulars-list', 'bill-schedule-list', 'branch-list', 'cabinet-list','case-status-list','case-title-list','case-category-list', 'case-matter-list', 'case-type-list', 'client-group-list', 'client-name-list', 'client-which-party-list', 'complainant-list', 'coordinator-or-tadbirkar-list', 'court-name-list', 'court-order-list', 'court-proceeding-list', 'day-notes-list', 'designation-list', 'documents-list', 'documents-type-list', 'external-council-list', 'internal-council-list', 'in-favour-of-list', 'law-list', 'legal-issue-list', 'legal-service-list', 'mode-of-received-list', 'next-date-fixed-for-list', 'next-day-presence-list', 'opposition-which-party-list', 'particulars-list', 'party-category-list', 'party-subcategory-list', 'payment-type-list', 'payment-mode-list', 'profession-list', 'program-list', 'progress-list', 'referrer-list', 'section-list', 'title-list', 'zone-list'])
...
{{--                            @endcanany--}}
                ...
                @canany(['civil-cases-list', 'criminal-cases-list', 'service-matter-list', 'quassi-judicial-cases-list', 'high-court-cases-list', 'appellate-court-cases-list', 'search-wizard-list', 'billing-list'])
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="nav-icon fas fa-circle"></i>
                            <p>
