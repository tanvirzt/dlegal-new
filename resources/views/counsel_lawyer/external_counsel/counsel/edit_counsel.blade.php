                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <a type="button" href="{{ url()->previous() }}" aria-disabled="false" role="link"
                                    tabindex="-1">Back </a>
                            </li>
                        </ol>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="counsel_type" class="form-control select2">
                                                        ...
                                                        <option value="Internal"
                                                            {{ $data->counsel_type == 'Internal' ? 'selected' : '' }}>
                                                            Internal</option>
                                                        <option value="External"
                                                            {{ $data->counsel_type == 'External' ? 'selected' : '' }}>
                                                            External</option>
                                                        <option value="Staff"
                                                            {{ $data->counsel_type == 'Staff' ? 'selected' : '' }}>Staff
                                                        </option>
                                                    </select>
                                                    @error('counsel_type')
                                            ...
                                            <div class="form-group row">
                                                <label for="counsel_category" class="col-sm-4 col-form-label"> Category
                                                </label>
                                                <div class="col-sm-8">
                                                    <select name="counsel_category" class="form-control select2">
                                                        <option value="">Select</option>
                                                        <option value="Chamber"
                                                            {{ $data->counsel_category == 'Chamber' ? 'selected' : '' }}>
                                                            Chamber</option>
                                                        <option value="Company"
                                                            {{ $data->counsel_category == 'Company' ? 'selected' : '' }}>
                                                            Company</option>
                                                    </select>
                                                    @error('counsel_category')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <select name="chamber_name" class="form-control select2">
                                                        ...
                                                        @foreach ($chamber as $item)
                                                            <option value="{{ $item->chamber_name }}"
                                                                {{ $data->chamber_name === $item->chamber_name ? 'selected' : '' }}>
                                                                {{ $item->chamber_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('chamber_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="counsel_role_id" class="form-control select2">
                                                        <option value="">Select</option>
                                                        <option value="Head of Chamber"
                                                            {{ $data->counsel_role_id == 'Head of Chamber' ? 'selected' : '' }}>
                                                            Head of Chamber</option>
                                                        <option value="Partner of Chamber"
                                                            {{ $data->counsel_role_id == 'Partner of Chamber' ? 'selected' : '' }}>
                                                            Partner of Chamber</option>
                                                        <option value="Associate"
                                                            {{ $data->counsel_role_id == 'Associate' ? 'selected' : '' }}>
                                                            Associate</option>
                                                        <option value="Admin of Chamber"
                                                            {{ $data->counsel_role_id == 'Admin of Chamber' ? 'selected' : '' }}>
                                                            Admin of Chamber</option>
                                                        <option value="Accountant"
                                                            {{ $data->counsel_role_id == 'Accountant' ? 'selected' : '' }}>
                                                            Accountant</option>
                                                        <option value="Head Clerk"
                                                            {{ $data->counsel_role_id == 'Head Clerk' ? 'selected' : '' }}>
                                                            Head Clerk</option>
                                                        <option value="Clerk"
                                                            {{ $data->counsel_role_id == 'Clerk' ? 'selected' : '' }}>Clerk
                                                        </option>
                                                        <option value="Support Staff"
                                                            {{ $data->counsel_role_id == 'Support Staff' ? 'selected' : '' }}>
                                                            Support Staff</option>
                                                    </select>
                                                    @error('counsel_role_id')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="counsel_name"
                                                        name="counsel_name" value="{{ $data->counsel_name }}">
                                                    @error('counsel_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="father_name"
                                                        name="father_name" value="{{ $data->father_name }}">
                                                    @error('father_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="mother_name" class="col-sm-4 col-form-label">Mother
                                                    Name</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="mother_name"
                                                        name="mother_name" value="{{ $data->mother_name }}">
                                                    @error('mother_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="spouse_name"
                                                        name="spouse_name" value="{{ $data->spouse_name }}">
                                                    @error('spouse_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="present_address"
                                                        name="present_address" value="{{ $data->present_address }}">
                                            ...
                                            <div class="form-group row">
                                                <label for="permanent_address" class="col-sm-4 col-form-label">Permanent
                                                    Address</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="permanent_address"
                                                        name="permanent_address" value="{{ $data->permanent_address }}">
                                            ...
                                            <div class="form-group row">
                                                <label for="date_of_birth" class="col-sm-4 col-form-label">Date of
                                                    Birth</label>
                                                <div class="col-sm-8">
                                                    ...
                                                    <span class="date_span">
                                                        <input type="date" class="xDateContainer date_first_input"
                                                            ...
                                                            id="xTime4" name="date_of_birth"
                                                            @if ($data->date_of_birth != null) value="{{ $data->date_of_birth }}" @else value="dd-mm-yyyy" @endif
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nid_number"
                                                        name="nid_number" value="{{ $data->nid_number }}">
                                                    @error('nid_number')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="mobile_number" class="col-sm-4 col-form-label">Mobile
                                                    Number</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="emergency_contact" class="col-sm-4 col-form-label">Emergency
                                                    Contact</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="emergency_contact"
                                                        name="emergency_contact" value="{{ $data->emergency_contact }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="relation"
                                                        name="relation" value="{{ $data->relation }}">
                                                    @error('relation')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="file" class="form-control" id="profile_image"
                                                        name="new_profile_image" style="padding-bottom: 27px;">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="profile_image" class="col-sm-4 col-form-label">Image</label>
                                                <div class="col-sm-8">
                                                    <img src="{{ asset('files/profile/' . $data->profile_image) }}"
                                                        style=" height:150px; weidth:150px;  border-radius: 50%;">
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="ssc_year"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="ssc_institution"
                                                            name="ssc_institution" placeholder="Institution"
                                                            value="{{ $data->ssc_institution }}">
                                                        @error('ssc_institution')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="hsc_year"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="hsc_institution"
                                                ...
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label">LL.B
                                                        (Hons)</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="llb_year"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="llb_institution"
                                                            name="llb_institution" placeholder="Institution"
                                                            value="{{ $data->llb_institution }}">
                                                        @error('llb_institution')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="llm_year"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="llm_instution"
                                                ...
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label">Bar Council
                                                        Enrollment</label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'bar_council_enrollment_date');"><input
                                                                type="text" id="bar_council_enrollment_date"
                                                                name="bar_council_enrollment_date"
                                                                @if ($data->bar_council_enrollment_date != null) value="{{ $data->bar_council_enrollment_date }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                        ...
                                                        @error('bar_council_enrollment_date')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        ...
                                                        @error('bar_council_enrollment_sanad_no')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label">Mother
                                                        Bar</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="mother_bar_name"
                                                            name="mother_bar_name" placeholder="Name"
                                                            value="{{ $data->mother_bar_name }}">
                                                        @error('mother_bar_name')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="mother_bar_membership_number"
                                                            placeholder="Membership No."
                                                            value="{{ $data->mother_bar_membership_number }}">
                                                        @error('mother_bar_membership_number')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label">Practicing
                                                        Bar</label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'practicing_bar_date');"><input
                                                                type="text" id="practicing_bar_date"
                                                                name="practicing_bar_date"
                                                                @if ($data->practicing_bar_date != null) value="{{ $data->practicing_bar_date }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="practicing_bar_membership_number"
                                                            placeholder="Membership No."
                                                            value="{{ $data->practicing_bar_membership_number }}">
                                                        @error('practicing_bar_membership_number')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> High Court
                                                        Enrollment </label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'high_court_enrollment_date');"><input
                                                                type="text" id="high_court_enrollment_date"
                                                                name="high_court_enrollment_date"
                                                                @if ($data->high_court_enrollment_date != null) value="{{ $data->high_court_enrollment_date }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                        ...
                                                        @error('high_court_enrollment_date')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="high_court_enrollment_membership_number"
                                                            placeholder="Membership No."
                                                            value="{{ $data->high_court_enrollment_membership_number }}">
                                                        @error('high_court_enrollment_membership_number')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'bar_council_fees');"><input
                                                                type="text" id="bar_council_fees"
                                                                name="bar_council_fees"
                                                                @if ($data->bar_council_fees != null) value="{{ $data->bar_council_fees }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                        ...
                                                        @error('bar_council_fees')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="bar_council_fees_write" name="bar_council_fees_write"
                                                            value="{{ $data->bar_council_fees_write }}">
                                                        @error('bar_council_fees_write')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> District Bar
                                                        Mem.
                                                        Fee (Update) </label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'district_bar_mem_fee');"><input
                                                                type="text" id="district_bar_mem_fee"
                                                                name="district_bar_mem_fee"
                                                                @if ($data->district_bar_mem_fee != null) value="{{ $data->district_bar_mem_fee }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                        ...
                                                        @error('district_bar_mem_fee')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="district_bar_mem_write" name="district_bar_mem_write"
                                                            value="{{ $data->district_bar_mem_write }}">
                                                        @error('district_bar_mem_write')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> SCBA Memb. Fee
                                                        (Update) </label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'scba_memb_fee');"><input
                                                                type="text" id="scba_memb_fee" name="scba_memb_fee"
                                                                @if ($data->scba_memb_fee != null) value="{{ $data->scba_memb_fee }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="scba_memb_fee_write" name="scba_memb_fee_write"
                                                            value="{{ $data->scba_memb_fee_write }}">
                                                        @error('scba_memb_fee_write')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> Professional
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        @error('professional_contact_number')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        ...
                                                        @error('professional_contact_number_write')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="professional_email" name="professional_email"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="professional_email_write" name="professional_email_write"
                                                            value="{{ $data->professional_email_write }}">
                                                        @error('professional_email_write')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> Name of
                                                        Associates
                                                    </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="name_of_associates" name="name_of_associates"
                                                            value="{{ $data->name_of_associates }}">
                                                        @error('name_of_associates')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            id="name_of_associates_write" name="name_of_associates_write"
                                                            value="{{ $data->name_of_associates_write }}">
                                                        @error('name_of_associates_write')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> Professoinal
                                                        Experience - 1 </label>
                                                    <div class="col-sm-8">
                                                        <textarea name="professional_experience_one" class="form-control" rows="3" placeholder="">{{ $data->name_of_associates_write }}</textarea>
                                                        @error('professional_experience_one')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> Professoinal
                                                        Experience - 2 </label>
                                                    <div class="col-sm-8">
                                                        <textarea name="professional_experience_two" class="form-control" rows="3" placeholder="">{{ $data->professional_experience_two }}</textarea>
                                                        @error('professional_experience_two')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="case_no" class="col-sm-4 col-form-label"> Date of Joining
                                                        (Chamber) </label>
                                                    <div class="col-sm-8">

                                                        <span class="date_span">
                                                            <input type="date" class="xDateContainer date_first_input"
                                                                onchange="setCorrect(this,'date_of_joining');"><input
                                                                type="text" id="date_of_joining"
                                                                name="date_of_joining"
                                                                @if ($data->date_of_joining != null) value="{{ $data->date_of_joining }}" @else value="dd-mm-yyyy" @endif
                                                                class="date_second_input" tabindex="-1"><span
                                                                class="date_second_span" tabindex="-1">&#9660;</span>
                                                        </span>
                                                        {{-- <input type="text" class="form-control"
