    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid py-2">
                <form action="{{ route('update-internal-counsel', $data->id) }}" method="post" enctype="multipart/form-data">

                    <!-- Default box -->
                    <div class="card">

                        <div class="card-header">
                            <h3 class="card-title"> Edit Internal Counsel </h3>
                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="internal_counsel_role_id" class="form-control select2">
                                                            ...
                                                            <option value="Head of Chamber" {{ $data->internal_counsel_role_id == "Head of Chamber" ? 'selected' : '' }}>Head of Chamber</option>
                                                            <option value="Partner of Chamber" {{ $data->internal_counsel_role_id == "Partner of Chamber" ? 'selected' : '' }}>Partner of Chamber</option>
                                                            <option value="Associate" {{ $data->internal_counsel_role_id == "Associate" ? 'selected' : '' }}>Associate</option>
                                                            <option value="Admin of Chamber" {{ $data->internal_counsel_role_id == "Admin of Chamber" ? 'selected' : '' }}>Admin of Chamber</option>
                                                            <option value="Accountant" {{ $data->internal_counsel_role_id == "Accountant" ? 'selected' : '' }}>Accountant</option>
                                                            <option value="Head Clerk" {{ $data->internal_counsel_role_id == "Head Clerk" ? 'selected' : '' }}>Head Clerk</option>
                                                            <option value="Clerk" {{ $data->internal_counsel_role_id == "Clerk" ? 'selected' : '' }}>Clerk</option>
                                                            <option value="Support Staff" {{ $data->internal_counsel_role_id == "Support Staff" ? 'selected' : '' }}>Support Staff</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="internal_counsel_name"
                                                               ...
                                                               value="{{ $data->internal_counsel_name }}">
