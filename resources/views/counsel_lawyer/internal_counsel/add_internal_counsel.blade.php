    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Internal Counsel</h1>
        ...
        <section class="content">
            <div class="container-fluid py-2">
                <form action="{{ route('save-internal-counsel') }}" method="post" enctype="multipart/form-data">

                    <!-- Default box -->
                    <div class="card">

                        <div class="card-header">
                            <h3 class="card-title"> Add Internal Counsel </h3>
                        </div>
                                ...
                                <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="internal_counsel_role_id" class="col-sm-4 col-form-label"> Role </label>
                                                    <div class="col-sm-8">
                                                        <select name="internal_counsel_role_id" class="form-control select2">
                                                        ...
                                                        @error('internal_counsel_role_id')<span
                                                            class="text-danger">{{$message}}</span>@enderror
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="internal_counsel_name" class="col-sm-4 col-form-label">Name</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="internal_counsel_name"
                                                               name="internal_counsel_name"
                                                               value="{{old('internal_counsel_name')}}">
                                                        @error('internal_counsel_name')<span
                                                            class="text-danger">{{$message}}</span>@enderror
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="ssc_year" class="col-sm-4 col-form-label">S.S.C</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                               id="ssc_year"
                                            ...
                                            <div class="form-group row">
                                                <label for="hsc_year" class="col-sm-4 col-form-label">H.S.C</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                               id="hsc_year"
                                            ...
                                            <div class="form-group row">
                                                <label for="llb_year" class="col-sm-4 col-form-label">LL.B (Hons)</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                               id="llb_year"
                                            ...
                                            <div class="form-group row">
                                                <label for="llm_year" class="col-sm-4 col-form-label">LL.M</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                               id="llm_year"
                                            ...
                                            <div class="form-group row">
                                                <label for="bar_council_enrollment_date" class="col-sm-4 col-form-label">Bar Council Enrollment</label>
                                                    <div class="col-sm-4">
                                            ...
                                            <div class="form-group row">
                                                <label for="mother_bar_name" class="col-sm-4 col-form-label">Mother Bar</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                               id="mother_bar_name"
                                            ...
                                            <div class="form-group row">
                                                <label for="practicing_bar_date" class="col-sm-4 col-form-label">Practicing Bar</label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                            ...
                                            <div class="form-group row">
                                                <label for="high_court_enrollment_date" class="col-sm-4 col-form-label"> High Court Enrollment </label>
                                                    <div class="col-sm-4">
                                                        <span class="date_span_counsel">
                                                            <input type="date" class="xDateContainer date_first_input"
                                            ...
                                            <div class="form-group row">
                                                <label for="professional_contact_number" class="col-sm-4 col-form-label"> Professional Contact Number </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <label for="professional_email" class="col-sm-4 col-form-label"> Professional Email </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <label for="name_of_associates" class="col-sm-4 col-form-label"> Name of Associates </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <label for="professional_experience_one" class="col-sm-4 col-form-label"> Professoinal Experience - 1 </label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="professional_experience_two" class="col-sm-4 col-form-label"> Professoinal Experience - 2 </label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="date_of_joining" class="col-sm-4 col-form-label"> Date of Joining (Chamber) </label>
                                                    <div class="col-sm-8">
                                                        <span class="date_span">
                                                            <input type="date" class="xDateContainer date_first_input"
