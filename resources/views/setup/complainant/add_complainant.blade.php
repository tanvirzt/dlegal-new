                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Add Complainant</h3>
                            </div>

                            <form action="{{ route('save-complainant') }}" enctype="multipart/form-data" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="complainant_mobile" name="complainant_mobile"  value="{{old('complainant_mobile')}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="complainant_address" class="form-control" rows="3"
                                                              placeholder="">{{ old('complainant_address') }}</textarea>
