                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="">
                            ...
                            <form action="{{ route('update-next-day-presence',$data->id) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="next_day_presence_name"> Reason for Next Date </label>
                                            <input type="text" class="form-control" name="next_day_presence_name"
                                                   id="next_day_presence_name" value="{{ $data->next_day_presence_name }}">
