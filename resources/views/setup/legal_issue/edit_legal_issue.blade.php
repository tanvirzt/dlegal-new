                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Edit Legal Issue</h3>
                            </div>

                            <form action="{{ route('update-legal-issue',$data->id) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="legal_issue_name"
                                                   id="legal_issue_name" value="{{ $data->legal_issue_name }}">
