                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    ...
                                    btn-success"><i class="fas fa-plus"></i> Add Relevant Law/Section </button></a>
                                </div>
                                ...
                                <table id="data_table" class="table dataTable no-footer dtr-inline">
                                    ...
                                    @foreach($data as $datum)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-law-section',$datum->id) }}"><button class="badge badge-info btn-sm"
                                                    >Edit</button></a>
                                                <span class="badge badge-danger btn-sm">
                                                <form method="POST" action="{{ route('delete-law-section',$datum->id) }}">
                                                    @csrf
