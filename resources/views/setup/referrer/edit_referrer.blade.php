                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Edit Referrer</h3>
                            </div>

                            <form action="{{ route('update-referrer',$data->id) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="referrer_name" name="referrer_name" value="{{ $data->referrer_name }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="referrer_mobile" name="referrer_mobile"  value="{{ $data->referrer_mobile }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="email" class="form-control" id="referrer_email" name="referrer_email" value="{{ $data->referrer_email }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="referrer_address" name="referrer_address" value="{{ $data->referrer_address }}">
