                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Edit Accused</h3>
                            </div>

                            <form action="{{ route('update-accused',$data->id) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="accused_mobile" name="accused_mobile"  value="{{ $data->accused_mobile }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="email" class="form-control" id="accused_email" name="accused_email" value="{{ $data->accused_email }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="accused_address" class="form-control" rows="3"
                                                              placeholder="">{{ $data->accused_address }}</textarea>
