                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    ...
                                    btn-success"><i class="fas fa-plus"></i> Add Internal Council </button></a>
                                </div>
                                ...
                                <table id="data_table" class="table dataTable no-footer dtr-inline">
                                    ...
                                    @foreach($data as $datum)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-internal-council',$datum->id) }}"><button class="badge badge-info btn-sm"
                                                    >Edit</button></a>
                                                <span class="badge badge-danger btn-sm">
                                                <form method="POST" action="{{ route('delete-internal-council',$datum->id) }}">
                                                    @csrf
