    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Supreme Court Category</h1>
                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Edit Supreme Court Category</h3>
                            </div>

                            <form action="{{ route('update-supreme-court-category',$data->id) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="supreme_court_category"
                                                   id="supreme_court_category" value="{{ $data->supreme_court_category }}">
