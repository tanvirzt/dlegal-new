                                ...
                                <table id="data_table" class="table dataTable no-footer dtr-inline">
                                    ...
                                    @foreach($data as $datum)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @can('court-order-edit')
                                                    <a href="{{ route('edit-court-last-order',$datum->id) }}"><button class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"
                                                    ><i class="fas fa-edit"></i></button></a>
                                                @endcan
                                                @can('court-order-delete')
                                                    <form method="POST" action="{{ route('delete-court-last-order',$datum->id) }}" class="delete-user btn btn-danger btn-xs">
                                                        @csrf
