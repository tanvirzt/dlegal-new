                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="float-right">
                                                    <a class="btn btn-success"
                                                        href="{{ route('view-civil-cases', $data->id) }}"> Preview </a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="date_of_filing" name="date_of_filing"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="ref_no" class="col-sm-4 col-form-label"> Ref No.
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="ref_no"
                                                                        name="ref_no" value="{{ $data->ref_no }}">
                                                                    @error('ref_no')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="case_status_id"
                                                                    class="col-sm-4 col-form-label">Case Status</label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="property_type_id"
                                                                    class="col-sm-4 col-form-label"> Property Type </label>
                                                                <div class="col-sm-8">
                                                                    <select name="property_type_id"
                                                                        ...
                                                                        @foreach ($property_type as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->property_type_id == $item->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="case_category_nature_id"
                                                                    class="col-sm-4 col-form-label">Case Category
                                                                    Nature</label>
                                                                <div class="col-sm-8">

                                                                    <select name="case_category_nature_id"
                                                                        class="form-control select2">
                                                                        <option value="">Select</option>
                                                                        @foreach ($case_category as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->case_category_nature_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->case_category_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('case_category_nature_id')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="case_type_id"
                                                                    class="col-sm-4 col-form-label">Type of Cases</label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="external_council_name_id"
                                                                    class="col-sm-4 col-form-label">External
                                                                    Council</label>
                                                                <div class="col-sm-8">
                                                                    <select name="external_council_name_id"
                                                                        class="form-control select2"
                                                                        ...
                                                                        @foreach ($external_council as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->external_council_name_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->first_name }}
                                                                                {{ $item->middle_name }}
                                                                                {{ $item->last_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('external_council_name_id')
                                                                        <span
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="external_council_associates_id"
                                                                        ...
                                                                        @foreach ($existing_ext_coun_associates as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->external_council_associates_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->first_name }}
                                                                                {{ $item->middle_name }}
                                                                                {{ $item->last_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('external_council_associates_id')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="relevant_law_sections_id"
                                                                    class="col-sm-4 col-form-label"> Relevant Laws/Sections
                                                                </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="plaintiff_name"
                                                                    class="col-sm-4 col-form-label">Plaintiff Name</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="plaintiff_name" name="plaintiff_name"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="next_date" class="col-sm-4 col-form-label">
                                                                    Next Date </label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="next_date" name="next_date"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="plaintiff_contact_number"
                                                                    class="col-sm-4 col-form-label">Plaintiff Contact
                                                                    No</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="next_date_fixed_id"
                                                                    class="col-sm-4 col-form-label"> Next date fixed for
                                                                </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="company_id" class="col-sm-4 col-form-label">
                                                                    Company </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="zone_id" class="col-sm-4 col-form-label"> Zone
                                                                </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="area_id" class="col-sm-4 col-form-label"> Area
                                                                </label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="subsequent_plaintiff_name"
                                                                    class="col-sm-4 col-form-label">Subsequent Plaintiff
                                                                    Name</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="subsequent_plaintiff_name"
                                                                        name="subsequent_plaintiff_name"
                                                                        value="{{ $data->subsequent_plaintiff_name }}">
                                                                    @error('subsequent_plaintiff_name')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="name_of_suit" class="col-sm-4 col-form-label">
                                                                    Name of the Suit </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="name_of_suit" name="name_of_suit"
                                                                        value="{{ $data->name_of_suit }}">
                                                                    @error('name_of_suit')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                <label for="defendent_name"
                                                                    class="col-sm-4 col-form-label"> Defendent Name
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="defendent_name" name="defendent_name"
                                                                        value="{{ $data->defendent_name }}">
                                                                    @error('defendent_name')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="defendent_address"
                                                                    class="col-sm-4 col-form-label"> Defendent Address
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="defendent_address" name="defendent_address"
                                                                        value="{{ $data->defendent_address }}">
                                                                    @error('defendent_address')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="defendent_company_id"
                                                                    class="col-sm-4 col-form-label"> Name of Defendent
                                                                    Company </label>
                                                                <div class="col-sm-8">
                                                                    <select name="defendent_company_id"
                                                                        class="form-control select2">
                                                                        <option value="">Select</option>
                                                                        @foreach ($company as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->defendent_company_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->company_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('defendent_company_id')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="date_of_incident"
                                                                    class="col-sm-4 col-form-label"> Date of incident
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="date_of_incident" name="date_of_incident"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <select name="last_order_court_id"
                                                                        class="form-control select2">
                                                                        <option value="">Select</option>
                                                                        @foreach ($last_court_order as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $data->last_order_court_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->court_last_order_name }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('last_order_court_id')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="date_of_incident_to"
                                                                    class="col-sm-4 col-form-label"> Date of Incident To
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="date_of_incident_to" name="date_of_incident_to"
                                                                        value="{{ $data->date_of_incident_to }}">
                                                                    @error('date_of_incident_to')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="additional_order"
                                                                    class="col-sm-4 col-form-label">Additional
                                                                    Order</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="additional_order" name="additional_order"
                                                                        value="{{ $data->additional_order }}">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="first_identification_person"
                                                                    class="col-sm-4 col-form-label"> Who identified the
                                                                    Incident First ? </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="first_identification_person"
                                                                        name="first_identification_person"
                                                                        value="{{ $data->first_identification_person }}">
                                                                    @error('first_identification_person')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="disbursement_date"
                                                                    class="col-sm-4 col-form-label">Disbursement
                                                                    Date</label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="date_of_identification"
                                                                    class="col-sm-4 col-form-label"> Date of Identification
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="date_of_identification"
                                                                        name="date_of_identification"
                                                                        value="{{ $data->date_of_identification }}">
                                                                    @error('date_of_identification')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="date_of_cash_receipt"
                                                                    class="col-sm-4 col-form-label"> Last date of Cash
                                                                    Receipt </label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="date_of_cash_receipt"
                                                                        name="date_of_cash_receipt"
                                                                        value="{{ $data->date_of_cash_receipt }}">
                                                                    @error('date_of_cash_receipt')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="case_notes" class="col-sm-4 col-form-label">
                                                                    Case Notes </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="case_notes" name="case_notes"
                                                                        value="{{ $data->case_notes }}">
                                                                    @error('case_notes')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="date_of_disposed"
                                                                    class="col-sm-4 col-form-label">Date of
                                                                    Disposed</label>
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        id="date_of_disposed" name="date_of_disposed"
                                                                        value="{{ $data->date_of_disposed }}">
                                                                    @error('date_of_disposed')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="power_of_attorny"
                                                                    class="col-sm-4 col-form-label"> Power of Attorny
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="power_of_attorny" name="power_of_attorny"
                                                                        value="{{ $data->power_of_attorny }}">
                                                                    @error('power_of_attorny')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="total_legal_bill_amount_cost"
                                                                    class="col-sm-4 col-form-label"> Total Legal Bill
                                                                    Amount & Cost </label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        id="total_legal_bill_amount_cost"
                                                                        name="total_legal_bill_amount_cost"
                                                                        value="{{ $data->total_legal_bill_amount_cost }}">
                                                                    @error('total_legal_bill_amount_cost')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="panel_lawyer_id"
                                                                    class="col-sm-4 col-form-label">Panel Lawyer</label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="assigned_lawyer_id"
                                                                    class="col-sm-4 col-form-label">Assigned Lawyer</label>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="notes" class="col-sm-4 col-form-label"> Notes
                                                                </label>
                                                                <div class="col-sm-8">
                                                                    <textarea name="notes" class="form-control" rows="3"
                                                                        placeholder="">{{ $data->notes }}</textarea>
                                                                    @error('notes')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="other_claim" class="col-sm-4 col-form-label">
                                                                    Other Claim(if any) </label>
                                                                <div class="col-sm-8">
                                                                    <textarea name="other_claim" class="form-control"
                                                                        rows="3"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="summary_facts_alligation"
                                                                    class="col-sm-4 col-form-label"> Summary of Facts &
                                                                    Alligation </label>
                                                                <div class="col-sm-8">
                                                                    <textarea name="summary_facts_alligation"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="missing_documents_evidence_information"
                                                                    class="col-sm-4 col-form-label"> Missing
                                                                    Documents/Evidence/Information </label>
                                                                <div class="col-sm-8">
                                                                    <textarea name="missing_documents_evidence_information"
                                                                        class="form-control" rows="3"
                                                                        placeholder="">{{ $data->missing_documents_evidence_information }}</textarea>
                                                                    @error('missing_documents_evidence_information')
                                                                        <span
                                                                            class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="input-group-btn">
                                                                        <button class="btn btn-success" type="button"><i
                                                                                class="fldemo glyphicon glyphicon-plus"></i>+</button>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="tab-content">
                                                    <div id="home" class="tab-pane active">
                                                        ...
                                                        <div class="card-header">
                                                            ...
                                                            <div class="float-right">
                                                                <a class="btn btn-success"
                                                                    href="{{ route('view-civil-cases', $data->id) }}">
                                                                    Preview </a>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="date" class="form-control"
                                                                                    ...
                                                                                    value="{{ $data->updated_next_date }}" required>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="date" class="form-control"
                                                                                    id="order_date" name="order_date" required>
                                                                                @error('order_date')
                                                                                    <span
                                                                                        class="text-danger">{{ $message }}</span>
                                                                                @enderror
