                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Add Flat Information</h3>
                            </div>

                            <form action="{{ route('save-flat-information') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="flat_area" name="flat_area" value="{{old('flat_area')}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="flat_owner" name="flat_owner" value="{{old('flat_owner')}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="checkbox" class="mt-2" id="land_compliance" name="flat_compliance" value="compliance">
                                                </div>
                                            </div>
