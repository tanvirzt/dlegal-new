                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="card">
                        <div class="">
                            ...
                            <form action="{{ route('save-document-list') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                            ...
                                            <div class="form-group row external_file_name">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="folder_name" name="folder_name" value="{{old('folder_name')}}">
