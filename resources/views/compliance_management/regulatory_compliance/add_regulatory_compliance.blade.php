                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        ...
                                                                        value="{{ old('certificates_getting_cl_first_date') }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="date" class="form-control"
                                                                        ...
                                                                        value="{{ old('certificates_expires') }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ old('certificates_special_provision') }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ old('certificates_special_remarks') }}">
