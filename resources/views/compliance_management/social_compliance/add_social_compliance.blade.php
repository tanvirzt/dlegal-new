        ...
        <section class="content">
            <div class="container-fluid py-2">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="">
                            <form action="{{ route('save-social-compliance') }}" method="post"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ old('compensation_benefit') }}">
